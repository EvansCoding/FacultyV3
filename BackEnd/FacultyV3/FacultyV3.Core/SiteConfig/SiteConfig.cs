namespace FacultyV3.Core.SiteConfig
{
    using Models.Enums;
    using Services;
    ...
    {
        private static string ConfigLocation => HostingEnvironment.MapPath("~/App_Data/faculty.config");
        ...
        {
            const string cacheKey = "facultysiteconfig";
